...
function  findPalindrome (e_array){
...
if(l1 = l2)
console.log("f. Median of two sorted array is: " + FindMedian(f_array1,f_array2));
console.log("----------------------");
...
console.log("g. Remove Duplicates in Array: " + remove_dups(g_array));
console.log("----------------------");
...
console.log("h. Rotate an array by k=3 times: " + rotateKtimes(h_array,k));
